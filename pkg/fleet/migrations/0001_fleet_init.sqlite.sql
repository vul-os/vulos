-- 0001_fleet_init.sqlite.sql
-- Fleet tables for the vulos.cloud control-plane fleet subsystem.
...
-- added by follow-on migrations; it is declared directly here. The trailing-
-- column layout mirrors SQLite's column-append storage so the resulting schema
-- is byte-identical to the prior migration chain.
...
CREATE TABLE IF NOT EXISTS fleet_org_members (
  ...
  joined_at    TEXT NOT NULL, display_name TEXT NOT NULL DEFAULT '',
