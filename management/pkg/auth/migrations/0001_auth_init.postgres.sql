-- 0001_auth_init.postgres.sql
-- Auth tables for vulos.cloud (Postgres), folded initial schema.
--
...
--              suspended, home_region and recovery_email (old 0003/0005/0007/
--              0008/0010/0014) are declared inline in final order.
--   * sessions: partial (old 0002) is folded inline.
...
CREATE TABLE IF NOT EXISTS users (
    ...
    email_verified_grace_until INTEGER,                       -- unix seconds; NULL = no grace
    preferred_2fa_modality     TEXT NOT NULL DEFAULT 'password+totp',
    suspended                  INTEGER NOT NULL DEFAULT 0,
    home_region                TEXT NOT NULL DEFAULT 'eu',
    recovery_email             TEXT                           -- optional out-of-network reset destination
);
...
CREATE TABLE IF NOT EXISTS sessions (
    ...
    partial      INTEGER NOT NULL DEFAULT 0               -- 1=post-password, pre-TOTP step
);
