...
> **Status.** Complete. All GAME tasks shipped: FPS config, gaming-mode encoder profiles, pointer-lock, shared gamepad hook, rumble, process priority, auto-enable on app category (GAME-07), and stream-toolbar UI (GAME-08) are all in.
