...
> **Non-goals.** Removing Chromium. Ladybird isn't yet a credible replacement for general browsing; this is an *additional* engine option, not a swap.
> **Status.** Feature-flagged launcher in place (LADYBIRD-01), falls back to Chromium when no binary is present.
