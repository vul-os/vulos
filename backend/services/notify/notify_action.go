...
// TypeAction is a Notification variant enriched with action specs.
...
// SendAction creates a TypeAction notification and broadcasts it.
// svc is the base *Service; specs lists the action buttons.
func SendAction(svc *Service, title, body string, level Level, source string, specs []ActionSpec) *TypeAction {
