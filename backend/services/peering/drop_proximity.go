...
//     configurable vulos.org rendezvous service.
//
...
// proxDefaultRendezvousBase is the default vulos.org rendezvous base URL.
// Override via VULOS_RENDEZVOUS_URL environment variable.
const proxDefaultRendezvousBase = "https://rendezvous.vulos.org"
...
//  2. If not found locally, forward the redemption request to the remote
//     vulos.org rendezvous service.
//
