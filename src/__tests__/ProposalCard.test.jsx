...
describe('ProposalCard', () => {
  it('renders the verb, summary and the "what will happen" key facts', () => {
    render(<ProposalCard proposal={EMAIL} state="pending" onApprove={() => {}} onReject={() => {}} />)
  ...
  it('surfaces untrusted message-derived targets as an alert', () => {
    ...
    render(<ProposalCard proposal={tainted} state="pending" onApprove={() => {}} onReject={() => {}} />)
  ...
  it('disables the buttons while busy and hides them once settled', () => {
    const { rerender } = render(
      <ProposalCard proposal={EMAIL} state="busy" onApprove={() => {}} onReject={() => {}} />,
    )
    expect(screen.getByRole('button', { name: 'Working…' })).toBeDisabled()

    rerender(<ProposalCard proposal={EMAIL} state="done" onApprove={() => {}} onReject={() => {}} />)
    ...
    rerender(<ProposalCard proposal={EMAIL} state="rejected" onApprove={() => {}} onReject={() => {}} />)
