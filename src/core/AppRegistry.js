...
export function getApps() {
  // Dedup AI apps against installedApps by id as well
  const ai5Deduped = ai5AIApps.filter(a => !installedApps.some(b => b.id === a.id))
  return [...builtinRegistry, ...installedApps, ...ai5Deduped]
}
