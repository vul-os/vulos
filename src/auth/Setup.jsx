...
// INIT-09: New-system flow steps (chooser inserted after welcome)
const STEPS = ['welcome', 'IS09_chooser', 'language', 'timezone', 'network', 'account', 'pin', 'appearance', 'ready']

// INIT-09: Join-existing flow steps (after chooser → connect storage → syncing → pin → ready)
